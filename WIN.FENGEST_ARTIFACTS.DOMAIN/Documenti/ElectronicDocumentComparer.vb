...
Public Class ElectronicDocumentComparer
   ...
   Public Function Compare(ByVal x As Object, ByVal y As Object) As Integer Implements IComparer.Compare
      ...
      Dim t1 As ElectronicDocument = DirectCast(x, ElectronicDocument)
      Dim t2 As ElectronicDocument = DirectCast(y, ElectronicDocument)
      ...
      End Try
   End Function
   Public Function GetPropertyValueFor(ByVal Item As ElectronicDocument) As Object
      ...
      Select Case m_PropertyName
         ...
         Case "Note"
            Return Item.Notes
         Case "NomeFile"
            Return Item.FileNameWithoutPath
         Case "TipoDocumento"
            Return Item.TipoDocumentazione.Descrizione
         Case Else
            Return "#"
      End Select
