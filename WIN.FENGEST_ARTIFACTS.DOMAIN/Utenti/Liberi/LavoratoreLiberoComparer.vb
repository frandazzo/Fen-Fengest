...
Public Class LavoratoreLiberoComparer
   ...
   Public Function Compare(ByVal x As Object, ByVal y As Object) As Integer Implements IComparer.Compare
      ...
      Dim t1 As DTOLavoratoreLibero = DirectCast(x, DTOLavoratoreLibero)
      Dim t2 As DTOLavoratoreLibero = DirectCast(y, DTOLavoratoreLibero)
      ...
      End Try
   End Function
   Public Function GetPropertyValueFor(ByVal Item As DTOLavoratoreLibero) As Object
      ...
      Select Case m_PropertyName
         ...
         Case "Azienda"
            Return Item.NomeAzienda
         Case "CodiceFiscale"
            Return Item.CodiceFiscale
         Case "LiberoAl"
            Return Item.LiberoAl
         Case Else
            Return "#"
      End Select
