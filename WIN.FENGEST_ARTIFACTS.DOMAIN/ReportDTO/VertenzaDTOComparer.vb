...
Public Class VertenzaDTOComparer
   ...
   Public Function Compare(ByVal x As Object, ByVal y As Object) As Integer Implements IComparer.Compare
      ...
      Dim t1 As VertenzaDTO = DirectCast(x, VertenzaDTO)
      Dim t2 As VertenzaDTO = DirectCast(y, VertenzaDTO)
      ...
      End Try
   End Function
   Public Function GetPropertyValueFor(ByVal Item As VertenzaDTO) As Object
