...
Public Class PrestazioneDTOComparer
   ...
   Public Function Compare(ByVal x As Object, ByVal y As Object) As Integer Implements IComparer.Compare
      ...
      Dim t1 As PrestazioneDTO = DirectCast(x, PrestazioneDTO)
      Dim t2 As PrestazioneDTO = DirectCast(y, PrestazioneDTO)
      ...
      End Try
   End Function
   Public Function GetPropertyValueFor(ByVal Item As PrestazioneDTO) As Object
