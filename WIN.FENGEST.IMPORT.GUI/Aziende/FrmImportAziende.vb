...
Public Class FrmImportAziende
    Private WithEvents scheduler As ImportAziendeScheduler
    ...
    Private Sub cmdImport_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdImport.Click
        Try
            ...
            If txtFile.Text = "" Then
                ...
                Exit Sub
            End If
            If Not (My.Computer.FileSystem.GetFileInfo(txtFile.Text).Extension = ".xls" Or My.Computer.FileSystem.GetFileInfo(txtFile.Text).Extension = ".xlsx") Then
                MsgBox("Inserire un file di importazione di tipo Excel", MsgBoxStyle.Information)
                Exit Sub
            End If

            scheduler = New ImportAziendeScheduler(txtFile.Text, txtLog.Text, chkUpdate.Checked)
    ...
    Private Sub scheduler_EndWriting(ByVal Errors As Integer, ByVal Inserted As Integer) Handles scheduler.EndWriting
        ...
        Me.lstActivity.Items.Add("Importazione terminata con " & Errors & " errori e con " & Inserted & " agrafiche correttamente inserite o aggiornate")
        System.Windows.Forms.Application.DoEvents()
    End Sub
