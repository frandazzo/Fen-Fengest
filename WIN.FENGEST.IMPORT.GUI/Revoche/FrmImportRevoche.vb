...
Public Class FrmImportRevoche
    Private WithEvents scheduler As ImportRevocheScheduler
    ...
    Private Sub cmdImport_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdImport.Click
        Try
            ...
            scheduler = New ImportRevocheScheduler(txtFile.Text, txtLog.Text, chkUpdate.Checked, chkAddDelega.Checked, chkRavokeAll.Checked)
    ...
    Private Sub scheduler_EndWriting(ByVal Errors As Integer, ByVal Inserted As Integer) Handles scheduler.EndWriting
        ...
        Me.lstActivity.Items.Add("Importazione terminata con " & Errors & " errori e con " & Inserted & " disdette correttamente inserite")
        System.Windows.Forms.Application.DoEvents()
    End Sub
