...
Public Class FrmImportUtenti
    Private WithEvents scheduler As ImportUtentiScheduler
    ...
    Private Sub cmdImport_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdImport.Click
        Try
            ...
            scheduler = New ImportUtentiScheduler(txtFile.Text, txtLog.Text, chkUpdate.Checked, chkList.Checked, CheckBox1.Checked, chkCodiceFiscale.Checked)
    ...
    Private Sub scheduler_EndWriting(ByVal Errors As Integer, ByVal Inserted As Integer) Handles scheduler.EndWriting
        ...
        Me.lstActivity.Items.Add("Importazione terminata con " & Errors & " errori e con " & Inserted & " anagrafiche correttamente inserite o aggiornate")
        System.Windows.Forms.Application.DoEvents()
    End Sub

    Private Sub scheduler_ListCreated(ByVal ListName As String) Handles scheduler.ListCreated
        Me.txtTask.Text = "Lista di lavoro creata con successo: " & ListName & "!"
        System.Windows.Forms.Application.DoEvents()
    End Sub
    ...
    Private Sub scheduler_WritingRecord(ByVal IdRecord As Integer) Handles scheduler.WritingRecord
        Me.txtTask.Text = "Srittura del record " & IdRecord.ToString
        System.Windows.Forms.Application.DoEvents()
    End Sub
