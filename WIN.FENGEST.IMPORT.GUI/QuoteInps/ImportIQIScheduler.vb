...
Public Class ImportIQIScheduler
    ...
    Protected FileLogName = "ImportIQI"
    Protected WithEvents m_DataRetriver As DataRetrieverIQI
    ...
    Public Sub New(ByVal Filename As String, ByVal LogFilePath As String)
        m_DataRetriver = New DataRetrieverIQI(Filename)
    ...
    Public Sub BackGroundStartImport(retirevedData As IList)
        Data = retirevedData
        m_LogPath = Environment.GetFolderPath(Environment.SpecialFolder.DesktopDirectory)
