Public Class ItemsImportoComparer
   Implements IComparer
   Private m_PropertyName As String = ""
   Private m_descending As Boolean = False
   Public Shared Function GetItemComparer(ByVal PropertyName As String, Optional ByVal Descending As Boolean = False) As ItemsImportoComparer
      Return New ItemsImportoComparer(PropertyName, Descending)
   End Function
