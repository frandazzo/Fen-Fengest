Public Class ItemCompetenzaComparer
   Implements IComparer
   Private m_PropertyName As String = ""
   Private m_descending As Boolean = False
   Public Shared Function GetItemComparer(ByVal PropertyName As String, Optional ByVal Descending As Boolean = False) As ItemCompetenzaComparer
      Return New ItemCompetenzaComparer(PropertyName, Descending)
   End Function
   ...
   Public Function Compare(ByVal x As Object, ByVal y As Object) As Integer Implements IComparer.Compare
      ...
      End If
   End Function
   Public Function GetPropertyValueFor(ByVal Item As ItemContabile) As AbstractPeriodo
