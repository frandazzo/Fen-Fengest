Public Class OpenNewPrestazioneCommand
   ...
   Protected Overrides Function DoCreateTargetControl() As PRESENTATION.BrowserControl
      Dim control As BrowserControl = New ControlPrestazioni
        control.StartCreateOperation()
        Return Control
    End Function
    Protected Overrides Function DoCreateTargetControl(ByVal Id As Int32) As PRESENTATION.BrowserControl
        Dim control As BrowserControl = New ControlPrestazioni(m_IdUtente, False)
        control.StartCreateOperation()
        Return control
    End Function
