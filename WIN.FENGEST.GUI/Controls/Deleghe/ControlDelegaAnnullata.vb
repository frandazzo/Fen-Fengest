...
Public Class ControlDelegaAnnullata
...
#Region "Metodi per Load iniziale"
    Protected Overrides Sub Nested_PrepareLoading()
        ...
        MasterControl.Instance.ParentForm.Text = "Visualizzazione delega annullata"
    ...
    Protected Overrides Sub Nested_LoadEditorsProperties()
        ...
        End If
        dtpData.Value = controller.DataAnnullamento
        ...
        End If
        If controller.DelegaAnnullamentoIsNull Then
            SpRipristina.Visible = True
            'lblRipristina.Visible = True
        Else
            SpRipristina.Visible = False
            'lblRipristina.Visible = False
        End If
    End Sub
