...
Partial Class ControlFondi
    ...
    Private Sub InitializeComponent()
        ...
        Me.HelpProvider1.SetHelpString(Me.CmdSel, "Funzione che permette di visualizzare la descrizione del fondo di previdenza sele" & _
                "zionato. Essa può essere modificata e poi salvata.")
