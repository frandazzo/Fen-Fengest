...
<SecureContext()> _
Public Class ControlEnteBilaterale
   Private controller As New AZIENDE.ControllerEntiBilaterali

   Public Sub New(ByVal IdEnte As Int32)
      InitializeComponent()
      Me.m_IdShowedObject = IdEnte
      Try
         DoLoad()
   ...
   End Sub
    Public Overrides Sub Nested_NotifyParent()
        MasterControl.Instance.ParentForm.Text = "" & MyBase.State.StateName & " ente bilaterale"
        MasterControl.Instance.GetMdi.ToolStripStatusLabel1.Text = "" & MyBase.State.StateName & " ente bilaterale "
   ...
   End Sub
    ...
    Protected Overrides Sub Nested_PostLoadingActions()
        Dim logo As String = "" & MyBase.State.StateName & "  ente  "
    ...
    <Secure(Area:="Enti bilaterali", Alias:="Aggiornamento", Macroarea:="Anagrafiche")> _
    ...
    Public Overrides Sub StartChangeOperation()
        Try
            ...
            CustomBar1.SetStatus(True, CustomBar.ActionType.Informazioni)
            CustomBar1.SetStatus(True, CustomBar.ActionType.Elimina)
            CustomBar1.SetStatus(False, CustomBar.ActionType.Annulla)
            CustomBar1.SetStatus(False, CustomBar.ActionType.Salva)
...
#Region "Metodi per Load iniziale"
    Public Overrides Sub DoSearch()
        ...
        MasterControl.Instance.ParentForm.Text = "Visualizzazione ente"
...
#Region "Metodi per il salvataggio"
    ...
    Protected Overrides Sub Navigate()
        Try
            ...
            Me.NavigateWithoutHistoryTo("ViewEnte", ParameterList, True)
        Catch ex As AccessDeniedException
            MsgBox("Impossibile aggiornare l'oggetto. Accesso negato", MsgBoxStyle.Information, "Accesso negato")
        End Try
    End Sub
...
#Region "Metodi per l'aggiornamneto"
    ...
    Private Sub IdContoTextBox1_TextBoxChanged()
        'Me.Change()
    End Sub
    Private Sub cboPeriodi_SelectedIndexChanged(ByVal sender As System.Object, ByVal e As System.EventArgs)
        Me.StartChangeOperation()
    End Sub
