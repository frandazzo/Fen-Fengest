...
Public Class DocumentIQPMediator
    ...
    Public Sub DefineLayout(ByVal Control As BrowserControl, ByVal DocumentType As String) Implements IDocumentViewMediator.DefineDocumentViewLayout
        ...
        With controlDoc
            ...
            .SetNomeTipoDocumento("Incasso quote previsionali")
        End With
    ...
    Public Sub GetSpecificDocumentProperties(ByVal Control As BrowserControl, ByVal Controller As AbstractController) Implements IDocumentViewMediator.GetSpecificDocumentProperties
        Dim controllerDoc As ControllerIncassiQuotePrevisionali = DirectCast(Controller, ControllerIncassiQuotePrevisionali)
        ...
        End If
        gridloader = GridLoaderDocumentFactory.GetGridDocumentLoader("IQP", controlDoc.GridPosizioni)
    ...
    Private Sub LoadView()
        itemList = DirectCast(ControllerForSepThread, ControllerIncassiQuotePrevisionali).ListaPosizioniUtenti
        Grid.Invoke(deleg)
    End Sub
    ...
    Public Sub RefeshItemsGrid(ByVal Control As BrowserControl, ByVal controller As AbstractController) Implements IDocumentViewMediator.RefeshItemsGrid
        ...
        Else
            controlDoc = DirectCast(Control, ControlPagamentoQuotePrevisionali)
        End If
    ...
    Public Sub ViewItemDetail(ByVal Controller As AbstractController) Implements IDocumentViewMediator.ViewItemDetail
        frm = New FrmItemContabile("View", Controller, "IQP")
        frm.ShowDialog()
        frm.Dispose()
    End Sub
