...
#Region "Istruzioni Sql"
    ...
    Protected Overrides Function InsertStatement() As String
        Return "Insert into App_DocScope (DocScopeName, CreatedBy, CreatedOn, Color, ProtocolCode, Responsable, RespProtocolCode,DefaultPath) values ( @Desc, @CRby, @CRon, @col,@prcode, @resp, @repc, @def)"
    End Function


    Protected Overrides Function UpdateStatement() As String
        Return "UPDATE App_DocScope SET DocScopeName = @Desc, ModifiedBy = @MOby, ModifiedOn = @MOon, Color = @col, ProtocolCode=@prcode, Responsable = @resp, RespProtocolCode = @repc, DefaultPath=@def  WHERE (Id =@Id )"
    End Function
