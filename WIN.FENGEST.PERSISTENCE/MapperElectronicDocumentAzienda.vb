Public Class MapperElectronicDocumentAzienda
   Inherits MapperElectronicDocument


   Public Sub New()
      m_Table = "DB_DOCUMENTI_AZIENDA"
      m_TargetKey = "ID_AZIENDA"
   End Sub
   ...
   Protected Overloads Overrides Function DoLoad(ByVal Key As Key, ByVal rs As System.Collections.Hashtable, ByVal target As AbstractPersistenceObject) As AbstractPersistenceObject
      Dim ElectronicDocumentAzienda As New ElectronicDocumentAzienda()
      ElectronicDocumentAzienda.Target = target
      ...
      ElectronicDocumentAzienda.TipoDocumentazione = tipoDoc
      ElectronicDocumentAzienda.Data = DATA
      ElectronicDocumentAzienda.FullFileName = FILE_NAME
      ElectronicDocumentAzienda.Key = Key
        ElectronicDocumentAzienda.Notes = note
        ElectronicDocumentAzienda.Referente = referente
      Return ElectronicDocumentAzienda
   End Function
   ...
   Protected Overrides Sub LoadInsertCommandParameters(ByVal Item As AbstractPersistenceObject, ByVal Cmd As System.Data.IDbCommand)
      Dim doc As ElectronicDocumentAzienda = DirectCast(Item, ElectronicDocumentAzienda)
