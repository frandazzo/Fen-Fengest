Public Class MapperIncassoQuotaAssociativa
...
#Region "Istruzioni Sql"
   ...
   Protected Overrides Function FindByKeyStatement() As String
      Return "Select * from DB_DOCUMENTO_CONTABILE where Id = @Id and TIPO_DOCUMENTO = 'IQA'"
   End Function
...
#End Region
   ...
   Protected Overrides Function CreateNewObject() As AbstractPersistenceObject
      Return New IncassoQuotaAssociativa
   End Function

   Public Overrides Function FindObjectByIdReloadingCache(ByVal Id As Integer) As AbstractPersistenceObject

      Return DirectCast(MyBase.FindByKeyReloadingCache(New Key(Id)), IncassoQuotaAssociativa)
   ...
   Public Overrides Function FindObjectById(ByVal Id As Integer) As AbstractPersistenceObject
      ...
      Return DirectCast(MyBase.FindByKey(New Key(Id)), IncassoQuotaAssociativa)
   ...
   Protected Overrides Sub BuildObject(ByVal Item As AbstractPersistenceObject, ByVal Key As Key, ByVal rs As System.Collections.Hashtable)
      ...
      Dim Incasso As IncassoQuotaAssociativa = DirectCast(Item, IncassoQuotaAssociativa)
   ...
   Protected Overrides Sub LoadInsertCommandParameters(ByVal Item As AbstractPersistenceObject, ByVal Cmd As System.Data.IDbCommand)
      Try
         ...
         Dim Documento As IncassoQuotaAssociativa = DirectCast(Item, IncassoQuotaAssociativa)
