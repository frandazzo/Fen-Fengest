...
Public Class JournalingDataLoader
   ...
   Public Shared Sub LoadJournalingInsertCommandParameters(ByVal item As AbstractPersistenceObject, ByVal cmd As IDbCommand)
   ...
   Public Shared Sub LoadJournalingUpdateCommandParameters(ByVal item As AbstractPersistenceObject, ByVal cmd As IDbCommand)
