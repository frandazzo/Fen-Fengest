Public Class LaziLoadComuni
   ...
   Private ListLoader As MapperComune = PersistenceMapperRegistry.Instance.GetMapperByName("MapperComune")
   Private m_Id As Int32
   Private m_mode As Type

   Public Sub New(ByVal Id As Int32, ByVal searchType As Type)
      m_Id = Id
      m_mode = searchType
   End Sub
