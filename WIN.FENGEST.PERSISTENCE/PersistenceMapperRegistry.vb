''' <summary>
''' Questa classe mantiene una hash table di tutti i mapper dell'applicazione. 
''' La chiave di ogni mapper è il tipo dell'oggetto di dominio mappato sullo storage
''' </summary>
''' <remarks></remarks>
Public Class PersistenceMapperRegistry
    ...
    Public Function GetMapperByName(ByVal MapperName As String) As TECHNICAL.PERSISTENCE.IMapper Implements TECHNICAL.PERSISTENCE.IMapperFinder.GetMapperByName
        Dim map As Object
    ...
    ''' <returns></returns>
    ''' <remarks></remarks>
    Public Function GetMapperByObjectTypeName(ByVal ObjectTypeName As String) As TECHNICAL.PERSISTENCE.IMapper Implements TECHNICAL.PERSISTENCE.IMapperFinder.GetMapperByObjectTypeName
        Dim map As Object
    ...
    Public ReadOnly Property DBMappers As System.Collections.IEnumerable Implements TECHNICAL.PERSISTENCE.IMapperFinder.DBMappers
        Get
