Public Class LazyLoadPosizioniQuoteInps
   ...
   Private m_Pagamento As IncassoQuotaInps
   Private query As Query

   Public Sub New(ByVal Pagamento As IncassoQuotaInps)
   ...
   Private Sub PrepareQuery()
      ...
      Dim maincriteria As AndExp = New AndExp(Criteria.Equal("TIPO_DOCUMENTO_CONTABILE", "'IQI'"), Criteria.Equal("ID_DOCUMENTO_CONTABILE", m_Pagamento.Key.Value(0)))
