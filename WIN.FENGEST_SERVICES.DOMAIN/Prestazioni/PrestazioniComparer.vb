...
Public Class PrestazioniComparer
   ...
   Public Function Compare(ByVal x As Object, ByVal y As Object) As Integer Implements IComparer.Compare
      ...
      Dim t1 As Prestazione = DirectCast(x, Prestazione)
      Dim t2 As Prestazione = DirectCast(y, Prestazione)
      ...
      End Try
   End Function
   Public Function GetPropertyValueFor(ByVal Item As Prestazione) As Object
      ...
      Select Case m_PropertyName
         ...
         Case "TipoPrestazione"
            Return Item.TipoPrestazione.Descrizione
         Case "Id"
            Return Item.Id
         Case "IdPrestazione"
            Return Item.Id
