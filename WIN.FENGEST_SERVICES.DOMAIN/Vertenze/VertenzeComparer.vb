...
Public Class VertenzeComparer
   ...
   Public Function Compare(ByVal x As Object, ByVal y As Object) As Integer Implements IComparer.Compare
      ...
      Dim t1 As Vertenza = DirectCast(x, Vertenza)
      Dim t2 As Vertenza = DirectCast(y, Vertenza)
      ...
      End Try
   End Function
   Public Function GetPropertyValueFor(ByVal Item As Vertenza) As Object
      ...
      Select Case m_PropertyName
         ...
         Case "Azienda"
            Return Item.Azienda.Descrizione
         Case "Id"
            Return Item.Id
         Case "IdVertenza"
            Return Item.Id
         Case "PeriodoVertenza"
            Return Item.PeriodoVertenza
         Case Else
            Return "#"
      End Select
