...
Public Class ComunicazioniComparer
   ...
   Public Function Compare(ByVal x As Object, ByVal y As Object) As Integer Implements IComparer.Compare
      ...
      Dim t1 As Comunicazione = DirectCast(x, Comunicazione)
      Dim t2 As Comunicazione = DirectCast(y, Comunicazione)
      ...
      End Try
   End Function
   Public Function GetPropertyValueFor(ByVal Item As Comunicazione) As Object
