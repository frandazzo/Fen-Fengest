...
Public Class Chiusa
    ...
    Protected Overrides Function DoSecurityCheck(pratica As Pratica) As Boolean
        ...
        If pratica.TipoPratica.ClosedPracticeuser Is Nothing Then 'se è nullo verifico di essere l'owner
        ...
        If pratica.TipoPratica.ClosedPracticeuser.Id = SecurityManager.Instance.CurrentUser.ID Then
            Return True
        End If
