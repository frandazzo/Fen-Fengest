...
Public Class Controllo
    ...
    Protected Overrides Function DoSecurityCheck(pratica As Pratica) As Boolean
        ...
        If pratica.TipoPratica.ControlUser Is Nothing Then 'se è nullo verifico di essere l'owner
        ...
        If pratica.TipoPratica.ControlUser.Id = SecurityManager.Instance.CurrentUser.ID Then
            Return True
        End If
    ...
    Public Sub New()
        m_state = PracticeEnum.Controllo
    End Sub
    ...
    'posso passare allo stato precedente
    'End Sub
