...
Public Class Rigettata
    ...
    Protected Overrides Function DoSecurityCheck(pratica As Pratica) As Boolean
        ...
        If pratica.TipoPratica.RejectedPractice Is Nothing Then 'se è nullo verifico di essere l'owner
        ...
        If pratica.TipoPratica.RejectedPractice.Id = SecurityManager.Instance.CurrentUser.ID Then
            Return True
        End If
    ...
    Public Sub New()
        m_state = PracticeEnum.Rigettata
    End Sub
