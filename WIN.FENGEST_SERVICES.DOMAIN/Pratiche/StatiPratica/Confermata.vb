...
Public Class Confermata
    ...
    Protected Overrides Function DoSecurityCheck(pratica As Pratica) As Boolean
        ...
        If pratica.TipoPratica.DocumentationVerifiedUser Is Nothing Then 'se è nullo verifico di essere l'owner
        ...
        If pratica.TipoPratica.DocumentationVerifiedUser.Id = SecurityManager.Instance.CurrentUser.ID Then
            Return True
        End If
    ...
    Public Sub New()
        m_state = PracticeEnum.Confermata
    End Sub
