Public Class PartialUpdateUtenteCommand
    Implements ICommand
    Private m_parameters As Hashtable
    Private m_Id As String = "-1"
    Private m_changeComunicazione As Boolean
    Private m_changeResidanza As Boolean

    Public Sub New(ByVal parameters As Hashtable, ByVal idUtente As String, Optional changeComunicazione As Boolean = False, Optional changeResidenza As Boolean = False)
        m_Id = idUtente
        m_parameters = parameters
        m_changeComunicazione = changeComunicazione
        m_changeResidanza = changeResidenza
    End Sub


    Public Sub Execute() Implements BASEREUSE.ICommand.Execute
        If m_changeComunicazione = False And m_changeResidanza = False Then
            Return
        End If
        ...
        Try
            ...
            If m_changeResidanza Then
                ...
                controller.SetResidenza(m_parameters.Item("INDIRIZZO"), m_parameters.Item("PROVINCIA"), m_parameters.Item("COMUNE"), m_parameters.Item("CAP").ToString)
