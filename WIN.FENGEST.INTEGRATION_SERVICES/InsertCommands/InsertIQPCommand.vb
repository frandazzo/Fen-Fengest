Public Class InsertIQPCommand
    ...
    Public Sub Execute() Implements ICommand.Execute
        Dim controller As New WIN.APPLICATION.FINANCIAL_ARTIFACTS.ControllerIncassiQuotePrevisionali
        ...
        Try
            ...
            For Each elem As Hashtable In m_Parameters
                ...
                If IsNumeric(m_ItemParameters.Item("QUOTA")) Then
                ...
                Catch ex As Exception
                    Try
                        My.Computer.FileSystem.WriteAllText(m_FileLogName, "Riga " & (i + 2).ToString & " " & ex.Message & vbCrLf & vbCrLf, True)
    ...
    Private Sub CreateDocument(ByVal DocProperties As Hashtable, ByVal Controller As WIN.APPLICATION.FINANCIAL_ARTIFACTS.ControllerIncassiQuotePrevisionali)
