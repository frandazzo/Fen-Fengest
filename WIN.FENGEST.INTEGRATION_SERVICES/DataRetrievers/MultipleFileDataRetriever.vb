Imports WIN.APPLICATION.IMPORT_EXPORT_SERVICES.DataInfoRetrieverFactory
Imports System.IO
...
Public Class MultipleFileDataRetriever
    ...
    Protected m_retrieverType As RetrieverType
    ...
    'lettore dei file 
    Protected WithEvents m_infoRetriever As DataInfoRetriever
    ...
    Public Sub New(path As String, type As RetrieverType)
        m_path = path
        m_retrieverType = type
    End Sub
    ...
    Public Sub StartImport()
        ...
        For Each elem As String In m_files
            ...
            Try
                excelOpened = False
                m_infoRetriever = DataInfoRetrieverFactory.GetDataInfoRetriever(m_retrieverType, elem)
